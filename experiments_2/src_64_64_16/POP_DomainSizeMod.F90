...
! !DEFINED PARAMETERS:
   ...
   integer (POP_i4), parameter, public ::  &  ! model size parameters
      POP_nxGlobal =  64 ,&!320 extent of horizontal axis in i direction
      POP_nyGlobal = 64  ,&!384 extent of horizontal axis in j direction
   ...
   integer (POP_i4), parameter, public :: &
      ...
      !POP_blockSizeX = 8, &! size of block in first  horizontal dimension
      !POP_blockSizeY = 8   ! size of block in second horizontal dimension
